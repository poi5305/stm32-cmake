...
SET(STM32_CHIP_TYPES 301xx 302xx 303xx 334xx 373xx 378xx CACHE INTERNAL "stm32f3 chip types")
SET(STM32_CODES "301.." "302.." "303.." "334.." "373.." "378..")

MACRO(STM32_GET_CHIP_TYPE CHIP CHIP_TYPE)
    STRING(REGEX REPLACE "^[sS][tT][mM]32[fF](3[037][12348].[68BC]).*$" "\\1" STM32_CODE ${CHIP})
    SET(INDEX 0)
...
MACRO(STM32_GET_CHIP_PARAMETERS CHIP FLASH_SIZE RAM_SIZE)
    STRING(REGEX REPLACE "^[sS][tT][mM]32[fF](3[037][12348].[68BC]).*$" "\\1" STM32_CODE ${CHIP})
    STRING(REGEX REPLACE "^[sS][tT][mM]32[fF]3[037][12348].([68BC]).*$" "\\1" STM32_SIZE_CODE ${CHIP})
